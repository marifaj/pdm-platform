...
const AnomalySegment ANOMALY_SCHEDULE[] = {
  {SEC_TO_INDEX(60),  SEC_TO_COUNT(90), ANOM_TEMP_ONLY}, // 05:00-08:00
  {SEC_TO_INDEX(240),  SEC_TO_COUNT(90), ANOM_VIB_ONLY},  // 11:00-14:00
  {SEC_TO_INDEX(420), SEC_TO_COUNT(90), ANOM_BOTH}       // 17:00-20:00
};
